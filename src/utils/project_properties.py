...
def set_timeline_format(project_obj, width: int, height: int, frame_rate: float, interlaced: bool = False) -> bool:
    """
...
def get_color_settings(project_obj) -> Dict[str, Any]:
    ...
    try:
        ...
        settings = {}
        color_properties = ["colorScienceMode", "timelineColorSpace", "timelineGamma", "inputDRT", "outputDRT"]
        ...
        if "colorScienceMode" in settings:
            ...
            mode_names = {0: "DaVinci YRGB", 1: "DaVinci YRGB Color Managed", 2: "ACEScct"}
